...
class dogtaitujuanji(nn.Module):
    def  __init__(self):
        ...
        self.num_neighbors_list=[8,8]
        self.bn3 = nn.BatchNorm1d(2048)
        # self.b=nn.Parameter(torch.rand(2048))
        self.num_layers=4
        self.weigt1=nn.Parameter(torch.Tensor(2048,2048))
        self.weight2 = nn.Parameter(torch.Tensor(2048, 2048))
        self.gcn=[]
        self.sigmoid=nn.Sigmoid()
        # self.relu = nn.ReLU(inplace=True)
        self.gcn.append(SageGCN(2048,2048,self.weigt1,self.weight2))
        self.gcn.append(SageGCN(2048,2048,self.weigt1,self.weight2))
