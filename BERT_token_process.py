...
class CUHKPEDES_BERT_token(data.Dataset):
    ...
    #BERT
    pklname_list = ['RSTPReid/processed_data/train_save.pkl',
                    'RSTPReid/processed_data/val_save.pkl',
                    'RSTPReid/processed_data/test_save.pkl'
                    ]
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            ...
            img_path, caption, attention_mask, label = 'RSTPReid/' + self.train_images[index],self.train_captions[index], \
                                                       self.train_attention_mask[index], self.train_labels[index]
        elif self.split == 'val':
            img_path, caption, attention_mask, label = 'RSTPReid/' + self.val_images[index], self.val_captions[
                index], self.val_attention_mask[index], self.val_labels[index]
        else:
            img_path, caption, attention_mask, label = 'RSTPReid/'+self.test_images[index], self.test_captions[index],\
