...
class CUHKPEDES_BERT_token(data.Dataset):
    ...
    #BERT
    pklname_list = ['BERT_encode/BERT_id_train_64_new.npz',
                    'BERT_encode/BERT_id_val_64_new.npz',
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            img_path, caption, attention_mask, label = 'CUHK-PEDES/imgs/'+self.train_images[4], self.train_captions[1], \
                                                      self.train_attention_mask[1],self.train_labels[1]
        elif self.split == 'val':
            img_path, caption, attention_mask, label = 'CUHK-PEDES/imgs/'+self.val_images[5], self.val_captions[5],\
                                                      self.val_attention_mask[5],self.val_labels[5]
        else:
            img_path, caption, attention_mask, label = 'CUHK-PEDES/imgs/'+self.test_images[4], self.test_captions[4],\
                                                       self.test_attention_mask[4], self.test_labels[4]
