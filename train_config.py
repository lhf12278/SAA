...
def parse_args():
    parser = argparse.ArgumentParser(description='command for train on RSTPReid')
    ...
    #adam_setting
    parser.add_argument('--adam_lr', type=float, default=0.0000001, help='the learning rate of adam')
